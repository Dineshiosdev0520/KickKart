            ...
            VStack(alignment: .leading) {
                ...
                VStack(alignment: .leading) {
                    ...
                    if viewModel.isInCart {
                        LargeButtonView(text: "Remove From Cart", systemImage: "cart.fill.badge.minus", role: .destructive) {
                        ...
                        LargeButtonView(text: "Add To Cart", systemImage: "cart.fill.badge.plus", role: .standard) {
